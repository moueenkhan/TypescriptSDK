...
class ApiHelper
{
    ...
    public static function getJsonMapper(): JsonMapper
    {
        if (!isset(self::$mapper)) {
            ...
            self::$mapper->arChildClasses['YapstoneStagedOnBoardingServicesLib\\Models\\CreateAssetRequest'] = [
                'YapstoneStagedOnBoardingServicesLib\\Models\\CreatePropertyAssetRequest'
            ];
            self::$mapper->arChildClasses['YapstoneStagedOnBoardingServicesLib\\Models\\UpdateAssetRequest'] = [
                'YapstoneStagedOnBoardingServicesLib\\Models\\UpdatePropertyAssetRequest'
            ];
            self::$mapper->arChildClasses['YapstoneStagedOnBoardingServicesLib\\Models\\Asset'] = [
                'YapstoneStagedOnBoardingServicesLib\\Models\\PropertyAsset'
            ];
            self::$mapper->arChildClasses['YapstoneStagedOnBoardingServicesLib\\Models\\BaseType'] = [
                'YapstoneStagedOnBoardingServicesLib\\Models\\CreateAssetRequest',
                'YapstoneStagedOnBoardingServicesLib\\Models\\UpdateAssetRequest',
                'YapstoneStagedOnBoardingServicesLib\\Models\\CreatePropertyAssetRequest',
                'YapstoneStagedOnBoardingServicesLib\\Models\\UpdatePropertyAssetRequest'
            ];
            self::$mapper->arChildClasses['YapstoneStagedOnBoardingServicesLib\\Models\\BaseType2'] = [
                'YapstoneStagedOnBoardingServicesLib\\Models\\Asset',
                'YapstoneStagedOnBoardingServicesLib\\Models\\PropertyAsset'
            ];
        }
        return self::$mapper;
    ...
    public static function mapClass(
        ...
        string $classname,
        int $dimension = 0,
        string $namespace = 'YapstoneStagedOnBoardingServicesLib\Models'
    ) {
        try {
