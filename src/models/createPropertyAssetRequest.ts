...
export interface CreatePropertyAssetRequest extends CreateAssetRequest {
  name?: string;
  address?: Address;
...
export const createPropertyAssetRequestSchema: Schema<any> = object({
  ...
  type: ['type', optional(literal('CreatePropertyAssetRequest'))],
});
